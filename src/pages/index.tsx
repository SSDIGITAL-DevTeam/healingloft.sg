    ...
    return (
        <AppLayout>
            <main className="flex flex-col items-center justify-between">
                ...
                <div
                    id="home"
                    className="container relative min-h-[75vh] px-8 pb-8 pt-24 lg:py-28"
                >
                    <Image
                        priority
                        src={Banner}
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-y-8 p-16 text-center text-white">
                        ...
                        <h2 className="max-w-2xl text-lg font-medium uppercase">
                            Revitalize your body and mind after a long, tiring
                            day. <br /> You deserve some relaxation
                        </h2>
                ...
                <div className="w-full" ref={serviceRef}>
                    ...
                    <div className="container relative p-8">
                        <div
                            className="absolute -top-4 xl:-top-8 2xl:-top-24"
                            id="service"
                        ></div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <h3 className="mb-8 max-w-2xl lg:text-lg">
                                Soothe away any tiring, muscle stiffness, or
                                discomfort zone on your body then embrace the
                                relaxation and rejuvination for your body, mind,
                                and soul with our expert therapists
                            </h3>
                        ...
                        <div className="flex flex-col items-center py-12 text-center">
                            <div className="container p-8 text-white">
                                ...
                                <h3 className="mx-auto mb-8 max-w-2xl lg:text-lg">
                                    Soothe away any tiring, muscle stiffness, or
                                    discomfort zone on your body then embrace
                                    the relaxation and rejuvination for your
                                    body, mind, and soul with our expert
                                    therapists
                                </h3>
                            </div>
                            ...
                            <div className="container px-8 pb-8 2xl:py-16 flex flex-col md:flex-row gap-y-8 md:gap-x-16 xl:gap-x-16 xl:px-32 2xl:px-44 2xl:gap-x-32">
                                ...
                                <div className="w-full 2xl:scale-110">
                                    <div className="rounded-t-2xl bg-gradient-to-t from-[#CB9E00] via-[#FDD23A] to-[#CB9E00] w-full p-8 text-black">
                                        <h3 className="mb-8 text-sm font-semibold lg:text-xl">
                                            SPECIAL OFFER ON
                                        </h3>
                                    ...
                                    <div className="rounded-b-2xl bg-white px-12 2xl:px-26 py-16">
                                        <div className="text-center">
                                            <span className="text-7xl font-bold lg:text-8xl">
                                                $15
                                            </span>
                                            ...
                                            <p className="font-medium text-2xl lg:text-3xl mt-1.5">
                                                (9am - 4pm)
                                            </p>
                                        </div>
                ...
                <div className="w-full" ref={aboutRef}>
                    ...
                    <div className="container relative p-8">
                        ...
                        <div className="flex flex-col justify-center gap-y-4 py-8 text-center lg:flex-row lg:items-center lg:justify-between">
                            <div className="flex flex-col gap-4 lg:text-left">
                                <h3 className="font-medium italic text-tertiary lg:text-xl">
                                    – Step into our world
                                </h3>
                                ...
                                <h3 className="max-w-2xl leading-loose lg:text-lg">
                                    The Healing Loft is in the heartland of
                                    Serangoon Garden, Singapore. We provide a
                                    safe and clean environment, good massages,
                                    at reasonable prices to make our customer
                                    satisfied. We also committed to make our
                                    Customer&apos;s wellness to be our top
                                    priority by providing various services such
                                    as Aromatherapy, Ancient Acupressure
                                    Treatment, and Signature THL Treatment with
                        ...
                        <div className="flex flex-col justify-center gap-y-4 py-8 text-center lg:flex-row lg:items-center">
                            <div className="flex flex-col gap-4">
                                ...
                                <h3 className="leading-loose lg:text-lg">
                                    In search of a blissful escape to recharge
                                    your spirit?{" "}
                    ...
                    <div
                        ref={videoRef}
                        className={`p-8 lg:p-0 -mt-8 lg:min-h-screen w-full`}
                    >
                        {isYoutubeShow && (
                            <div className="">
                                {isLoading && (
                    ...
                    <div className="w-full">
                        <div className="container flex flex-col gap-4 p-8 text-center">
                            ...
                            <h2 className="text-2xl font-semibold text-primary lg:text-4xl">
                                PICTURE THE VIBES YOU&apos;LL{" "}
                                <br className="hidden lg:block" />
                                ENCOUNTER
                            </h2>

                            <h3 className="leading-loose lg:text-lg">
                                This is a glimpse of the atmosphere that exactly
                                you&apos;ll experience here. Immerse yourself in
                                the mood that awaits you
                            </h3>
                        </div>
                ...
                >
                    ...
                    <div className="w-full flex flex-col lg:flex-row gap-x-8 gap-y-28 container lg:p-8">
                        <div className="w-full flex flex-col items-center justify-center gap-y-6 lg:gap-y-2 text-center">
                            ...
                            <h2 className="text-4xl font-semibold text-primary lg:text-7xl mb-12">
                                CALL US NOW
                            </h2>
