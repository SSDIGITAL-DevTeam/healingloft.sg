        ...
        <footer className='bg-footer text-primary'>
            <div className='container p-4'>
                <div className='flex flex-col items-center gap-y-6 p-8'>
                    ...
                    <ul className='mt-2 flex w-max flex-col items-center gap-y-4 font-medium lg:flex-row lg:justify-center lg:gap-x-16'>
                        ...
                        <li className='flex gap-x-2 rounded-xl px-4 py-1.5 duration-150 hover:bg-primary hover:text-secondary lg:text-xl'>
                            <PhoneIcon className='w-4' />

                            <a id='phone-click-2' href='tel:+65 9144 4649'>
                                +65 9144 4649
                            </a>
                        </li>
            ...
            <div className='h-16 border-t border-primary/25 p-2 text-center'>
                <p className='lg:text-lg'>
                    Copyright © {new Date().getFullYear()} The Healing Loft. <br />
                    All Rights Reserved.
                </p>
            </div>
